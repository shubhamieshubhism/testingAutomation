    ...
    public void dynamicTable() throws InterruptedException {
        ...
        for (int r = 1; r < rows.size(); r++) {
            ...
            if (name.getText().equals("Chrome")) {
                ...
                //wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//td[normalize-space()='Chrome']/following-sibling::*[contains(text(),'%')]"))));
                //wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//p[@id='chrome-cpu']"))));
